...
public class MotifDegeneration {
	 ...
	 * @param proteinsInNetworkList_ ArrayList<Protein> - list of proteins in
	 *                               network
	...
	private Integer permutation(List<Character> NA, int k, String accumulated,
			HashMap<String, ArrayList<Integer>> container, int breaks, Integer fileIndex, String outputFilePrefix) {

...
public class IdentifyCoreProteins {
	...
	public static void main(String[] args) {
		...
		String distanceMatrix = args[2];
		double percentThreshold = Double.parseDouble(args[3]);
		String outputFile = args[4];

		getCoreProteins(annotationFile, percentThreshold, proteinFreqFile, distanceMatrix, outputFile);
	...
	public static void getCoreProteins(String annotationSubsetFile, double percentThreshold, String proteinInfoFile, String distanceMatrixFile, String corePorteinsFile) {
		...
		System.out.println("Determining coreProteins");

...
public class PositionConservation {
	...
	public void getMotifPositionsFromLongestSequences(String representativeMotifsFile, String filteredFastaFile, String motifOutputPrefixFile, int motifNumber) {
		...
		try {
			...
			while(line != null) {
				...
				if(!line.startsWith(">")) {
					...
					/* search for motif positions */
					motifPositions = getMotifPositions(possibleInstances, line, motifPositions);
